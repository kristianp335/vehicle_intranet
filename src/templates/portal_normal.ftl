		...
		<div id="wrapper">
			<header id="banner" role="banner">
				...
				<#if the_title?contains("Home") || the_title?contains("Welcome") >
					...
					<div class="intro-lead-in">Welcome to Material Engineering!</div>
					<div class="intro-heading">Being awesome since 2008</div>
					<a href="#services" class="page-scroll btn btn-xl">A button to nowhere</a>
				</#if>
			</header>
